...
with gr.Blocks() as app:
    ...
    def on_click_enlarge_eyes(global_state):
        ...
        landmarks_int = landmarks.astype(int)        
        points = global_state["points"]
        points[0] = {'start': landmarks_int[0][37], 'target': (landmarks_int[0][37][0],landmarks_int[0][37][1]-10)}
        points[1] = {'start': landmarks_int[0][38], 'target': (landmarks_int[0][38][0],landmarks_int[0][38][1]-10)}
        points[2] = {'start': landmarks_int[0][44], 'target': (landmarks_int[0][44][0],landmarks_int[0][44][1]-10)}
        points[3] = {'start': landmarks_int[0][43], 'target': (landmarks_int[0][43][0],landmarks_int[0][43][1]-10)}
        image_draw = update_image_draw(
            image_raw,
            global_state['points'],
            global_state['mask'],
